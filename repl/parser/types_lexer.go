...
const (
	TypesLexerEQUALS         = 1
	TypesLexerNOT_EQUALS     = 2
	TypesLexerIN             = 3
	TypesLexerLESS           = 4
	TypesLexerLESS_EQUALS    = 5
	TypesLexerGREATER_EQUALS = 6
	TypesLexerGREATER        = 7
	TypesLexerLOGICAL_AND    = 8
	TypesLexerLOGICAL_OR     = 9
	TypesLexerLBRACKET       = 10
	TypesLexerRPRACKET       = 11
	TypesLexerLBRACE         = 12
	TypesLexerRBRACE         = 13
	TypesLexerLPAREN         = 14
	TypesLexerRPAREN         = 15
	...
	TypesLexerMINUS          = 18
	TypesLexerEXCLAM         = 19
	TypesLexerQUESTIONMARK   = 20
	TypesLexerCOLON          = 21
	TypesLexerPLUS           = 22
	TypesLexerSTAR           = 23
	TypesLexerSLASH          = 24
	TypesLexerPERCENT        = 25
	TypesLexerCEL_TRUE       = 26
	TypesLexerCEL_FALSE      = 27
	TypesLexerNUL            = 28
	TypesLexerWHITESPACE     = 29
	TypesLexerCOMMENT        = 30
	TypesLexerNUM_FLOAT      = 31
	TypesLexerNUM_INT        = 32
	TypesLexerNUM_UINT       = 33
	TypesLexerSTRING         = 34
	TypesLexerBYTES          = 35
	TypesLexerIDENTIFIER     = 36
)
