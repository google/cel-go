...
def cel_go_test(
    ...
    go_test(
        ...
        data = data,
        deps = deps + [
            "@dev_cel_cel_go_policy//:go_default_library",
            "@dev_cel_cel_go_tools//celtest:go_default_library",
            "@dev_cel_cel_go_tools//compiler:go_default_library",
            "@dev_cel_cel_go//cel:go_default_library",
            "@dev_cel_cel_go//common/types:go_default_library",
            "@dev_cel_cel_go//common/types/ref:go_default_library",
            "@dev_cel_cel_go//interpreter:go_default_library",
            "@dev_cel_cel_go//test:go_default_library",
