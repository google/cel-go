...
func (GlobalEnum) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_test_all_types_e365f2c27f119ae8, []int{0}
}
...
func (TestAllTypes_NestedEnum) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_test_all_types_e365f2c27f119ae8, []int{0, 0}
}
...
func (*NestedTestAllTypes) Descriptor() ([]byte, []int) {
	return fileDescriptor_test_all_types_e365f2c27f119ae8, []int{1}
}
...
func init() {
	...
	proto.RegisterMapType((map[int64]*NestedTestAllTypes)(nil), "google.api.tools.expr.test.TestAllTypes.MapInt64NestedTypeEntry")
	proto.RegisterMapType((map[string]string)(nil), "google.api.tools.expr.test.TestAllTypes.MapStringStringEntry")
...
func init() {
	proto.RegisterFile("test/test_all_types.proto", fileDescriptor_test_all_types_e365f2c27f119ae8)
}

var fileDescriptor_test_all_types_e365f2c27f119ae8 = []byte{
