...
// NewPresenceTest creates a select expression that is a presence test generated by a macro.
//
// Example:
//
// has(msg.field_name)
// - operand: msg
// - field: field_name
func (opt *optimizerExprFactory) NewPresenceTest(operand ast.Expr, field string) ast.Expr {
...
func (opt *optimizerExprFactory) NewUnspecifiedExpr() ast.Expr {
	return opt.fac.NewUnspecifiedExpr(opt.nextID())
}
