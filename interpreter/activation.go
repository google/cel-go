...
type mapActivation struct {
	references map[int64]refpb.Value
...
func (a *mapActivation) ResolveName(name string) (refpb.Value, bool) {
	if object, found := a.bindings[name]; found {
		switch object.(type) {
		// Resolve a lazily bound value.
		case func() refpb.Value:
			return object.(func() refpb.Value)(), true
		// Otherwise, return the bound value.
		case refpb.Value:
			return object.(refpb.Value), true
		default:
			return typespb.NativeToValue(object), true
		}
	}
	return nil, false
}

func (a *mapActivation) ResolveReference(exprId int64) (refpb.Value, bool) {
...
func (a *hierarchicalActivation) ResolveName(name string) (refpb.Value, bool) {
...
func (a *hierarchicalActivation) ResolveReference(exprId int64) (refpb.Value, bool) {
